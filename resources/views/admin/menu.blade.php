        ...
        <div class="bg-white dark:bg-[#161615] shadow-md rounded-lg p-4 sm:p-6">
            ...
            <div class="mb-6">
                <div class="relative">
                    ...
                    <input type="text" id="menu-search" class="block w-full p-4 pl-10 text-sm text-[#1b1b18] border border-gray-300 rounded-lg bg-[#FDFDFC] focus:ring-[#f53003] focus:border-[#f53003] dark:bg-[#1E1E1C] dark:border-[#3E3E3A] dark:placeholder-[#A1A09A] dark:text-[#EDEDEC] dark:focus:ring-[#f53003] dark:focus:border-[#f53003]" placeholder="Search menu items...">
                </div>
            </div>
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Mie Ganas Special Nasi Goreng</p>
                            </div>
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Ayam original dengan kuah gurih</p>
                            </div>
                            <span class="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">Active</span>
                        </div>
                        <div class="mt-4 flex justify-between items-center">
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Bakso urat dengan kuah bening</p>
                            </div>
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Sate ayam dengan bumbu kacang</p>
                            </div>
                            <span class="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">Active</span>
                        </div>
                        <div class="mt-4 flex justify-between items-center">
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Es teh manis segar</p>
                            </div>
                            <span class="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">Active</span>
                        </div>
                        <div class="mt-4 flex justify-between items-center">
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Jus alpukat original</p>
                            </div>
                            <span class="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">Active</span>
                        </div>
                        <div class="mt-4 flex justify-between items-center">
