...
<div class="mb-6 overflow-x-auto">
    <div class="flex space-x-2 pb-2">
        <button 
            class="category-tab px-4 py-2 bg-[#f53003] text-white rounded-lg whitespace-nowrap active-category"
            data-category="all"
        >
            Semua Menu
        </button>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="menu-container">
    ...
    <!-- Mie Category -->
    <div class="menu-item bg-white dark:bg-[#1E1E1C] rounded-lg shadow border border-gray-200 dark:border-gray-700 overflow-hidden" data-category="mie">
        <div class="h-48 overflow-hidden">
            <img src="https://placehold.co/400x300" alt="Mie Goreng Spicy"
                class="w-full h-full object-cover">
        </div>
        <div class="p-4">
            <h3 class="text-lg font-bold text-[#1b1b18] dark:text-[#EDEDEC]">Mie Goreng Spicy</h3>
            <p class="text-sm text-[#706f6c] dark:text-[#A1A09A] mb-2">Delicious fried noodles with our signature spicy sauce</p>
            ...
            <button class="add-to-cart w-full px-4 py-2 bg-[#f53003] hover:bg-[#d92902] text-white rounded-lg transition duration-300">
                Pesan
            </button>
        </div>
    </div>
    ...
    <div class="menu-item bg-white dark:bg-[#1E1E1C] rounded-lg shadow border border-gray-200 dark:border-gray-700 overflow-hidden" data-category="mie">
        <div class="h-48 overflow-hidden">
            <img src="https://placehold.co/400x300" alt="Mie Rebus Special"
                class="w-full h-full object-cover">
        </div>
        <div class="p-4">
            <h3 class="text-lg font-bold text-[#1b1b18] dark:text-[#EDEDEC]">Mie Rebus Special</h3>
            <p class="text-sm text-[#706f6c] dark:text-[#A1A09A] mb-2">Our special noodle soup with rich and flavorful broth</p>
            <div class="flex justify-between items-center mb-3">
    ...
    <!-- Minuman Category -->
    <div class="menu-item bg-white dark:bg-[#1E1E1C] rounded-lg shadow border border-gray-200 dark:border-gray-700 overflow-hidden" data-category="minuman">
        <div class="h-48 overflow-hidden">
            <img src="https://placehold.co/400x300" alt="Es Teh Tarik"
                class="w-full h-full object-cover">
        </div>
        <div class="p-4">
    ...
    <div class="menu-item bg-white dark:bg-[#1E1E1C] rounded-lg shadow border border-gray-200 dark:border-gray-700 overflow-hidden" data-category="minuman">
        <div class="h-48 overflow-hidden">
            <img src="https://placehold.co/400x300" alt="Jus Alpukat"
                class="w-full h-full object-cover">
        </div>
        <div class="p-4">
    ...
    <!-- Snack Category -->
    <div class="menu-item bg-white dark:bg-[#1E1E1C] rounded-lg shadow border border-gray-200 dark:border-gray-700 overflow-hidden" data-category="snack">
        <div class="h-48 overflow-hidden">
            <img src="https://placehold.co/400x300" alt="Kerupuk"
                class="w-full h-full object-cover">
        </div>
        <div class="p-4">
    ...
    <div class="menu-item bg-white dark:bg-[#1E1E1C] rounded-lg shadow border border-gray-200 dark:border-gray-700 overflow-hidden" data-category="snack">
        <div class="h-48 overflow-hidden">
            <img src="https://placehold.co/400x300" alt="Pangsit"
                class="w-full h-full object-cover">
        </div>
        <div class="p-4">
...
<div class="fixed bottom-6 right-6 z-50">
    <button class="px-6 py-3 bg-[#f53003] hover:bg-[#d92902] text-white rounded-full shadow-lg flex items-center space-x-2 transition duration-300">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    categoryTabs.forEach(tab => {
        tab.addEventListener('click', function() {
            ...
            // Update active tab
            categoryTabs.forEach(t => t.classList.remove('active-category', 'bg-[#f53003]', 'text-white'));
            categoryTabs.forEach(t => t.classList.add('bg-gray-200', 'text-[#1b1b18]', 'dark:bg-gray-700', 'dark:text-[#EDEDEC]'));
            
            this.classList.add('active-category', 'bg-[#f53003]', 'text-white');
            this.classList.remove('bg-gray-200', 'text-[#1b1b18]', 'dark:bg-gray-700', 'dark:text-[#EDEDEC]');
    ...
    searchInput.addEventListener('input', function() {
        ...
        menuItems.forEach(item => {
            ...
            const activeCategory = document.querySelector('.active-category').getAttribute('data-category');
